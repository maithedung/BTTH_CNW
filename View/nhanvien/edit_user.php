...
<head>
    ...
    <title>Mai The Dung</title>
    <meta name="description" content="Mai The Dung">
    ...
    <link rel="stylesheet" href="assets/css/cs-skin-elastic.css" href="">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Edit</strong><small> Employee</small></div>
                            <div class="card-body card-block">
                                <form action="" method="post">
                                    <div class="form-group"><label for="company"
                                            class=" form-control-label">Name</label><input type="text" id="company"
                                            placeholder="Enter your name" class="form-control" name="name"
                                            value="<?php echo $dataID['hoten']; ?>">
                                    </div>
                                    <div class="form-group"><label for="vat"
                                            class=" form-control-label">IDPB</label><input type="text" id="vat"
                                            placeholder="IDPB" class="form-control" name="idpb"
                                            value="<?php echo $dataID['idpb']; ?>"></div>
                                    <div class="form-group"><label for="street"
                                            ...
                                            value="<?php echo $dataID['diachi']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <input onclick="return confirm('Are you sure save?')" type="submit" value="Save"
                                            class="btn btn-lg btn-info btn-block" name="update_user">
                                    </div>
                                    <div class="form-group">
                                        <input onclick="return confirm('Are you sure delete?')" type="submit"
                                            value="Delete" class="btn btn-lg btn-warning btn-block" name="delete_user">
                                    </div>
                                </form>
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; 2020 ZerosX Team
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by <a href="https://fb.com/maithedungg">Mai The Dung</a>
                    </div>
                </div>
            </div>
        </footer>
